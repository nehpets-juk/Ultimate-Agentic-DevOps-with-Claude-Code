...
- [ ] Sync site files: `aws s3 sync . s3://<bucket> --exclude "terraform/*" --exclude ".git/*" --exclude ".github/*" --exclude "*.md" --exclude ".claude/*" --exclude ".cursor/*" --exclude ".mcp.json" --exclude ".gitignore" --delete`
